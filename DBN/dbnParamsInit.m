...
rbmParams.lrW_linear = 0.001; % learningRate for weights when one layer is linear
rbmParams.lrVb_linear = 0.001; % learningRate for visible biases when one layer is linear
rbmParams.lrHb_linear = 0.001; % learningRate for hidden biases when one layer is linear

rbmParams.sigmaInit = 0.1; %Standard deviation of gaussian initialisation
rbmParams.sigmaInit_linear = 0.01; % Standard deviation of gaussian initialisation when one layer is ReLu
